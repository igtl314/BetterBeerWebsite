...
export default async function StoresPage() {
  ...
  return (
    <main className="pb-[90px] sm:pb-0">
      ...
      {/* Hero */}
      <section
        className="px-5 pt-2 pb-4 sm:px-14 sm:pt-10 sm:pb-8"
      ...
      {/* Mobile-only visual search placeholder */}
      <section
        className="sm:hidden"
        style={{ padding: '14px 20px', borderBottom: '1px solid var(--idx-line)' }}
      >
        <div style={{
      ...
      {/* Store list */}
      <section className="px-5 sm:px-14 sm:pt-12 sm:pb-20">
        {stores.length === 0 ? (
          <div
